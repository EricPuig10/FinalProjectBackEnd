...
public class BootcampMapper {
    ...
    public Bootcamp mapRequestToBootcampToEdit(BootcampReqDto bootcampReqDto,Bootcamp bootcamp, Category category){
        ...
        bootcamp.setFormer(bootcamp.getFormer());
        bootcamp.setCoformer(bootcamp.getCoformer());
        bootcamp.setInitialDate(bootcamp.getInitialDate());
        bootcamp.setFinalDate(bootcamp.getFinalDate());
        return bootcamp;
    }
